...
This project (Torque Roast Scheduler — a single-file PWA in `index.html`, backed by Supabase) keeps three kinds of documentation:

- **[JOURNAL.md](./JOURNAL.md)** — chronological narrative of what was done, tried, abandoned, and fixed. Newest entry at top.
